...
class MainWindow(QMainWindow):
    ...
    def _setup_ui(self):
        ...
        brand_caption = QLabel("Bilibili 下载器")
        ...
        page_title = QLabel("下载")
        page_title.setObjectName("PageTitle")
        page_caption = QLabel("解析链接，选择规格，加入下载队列")
